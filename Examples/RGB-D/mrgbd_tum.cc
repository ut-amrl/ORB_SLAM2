...
int main(int argc, char **argv)
{
    if(argc != 6)
    {
        cerr << endl << "Usage: ./rgbd_tum path_to_vocabulary path_to_settings path_to_sequence path_to_association path_to_output_dir" << endl;
        return 1;
    }
    ...
    SLAM.isOffline = true;
    SLAM.dumpToFilePath = string(argv[5]);
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        SLAM.TrackRGBD(imRGB,imD,integer_timestamp);
